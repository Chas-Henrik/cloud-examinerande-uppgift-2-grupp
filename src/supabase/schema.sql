...
-- Create index for better query performance
CREATE INDEX IF NOT EXISTS user_files_entry_id_idx ON public.user_files(entry_id);

-- Create policy: Users can only see their own user_files
CREATE POLICY "Users can view their own user_files"
